...
const WhyChooseArr = [
  {
    ...
    title: "Fast Building",
    description:
      "Fast and efficient building services to help you create the perfect space for your home or business.",
  },
...

  {
    ...
    title: "Smart Execute",
    description:
      "We use the latest technology and tools to ensure that your project is completed on time.",
  },
...
const WhyChooseSection = () => {
  return (
    <section className="bg-white py-24 lg:px-24 px-4 flex flex-col lg:flex-row items-start gap-14">
      {/* image grid */}
      <div className="grid lg:grid-cols-2 items-start gap-4 flex-1 order-2 lg:order-none">
      ...
      {/* reasons contents */}
      <div className="flex flex-col gap-6 flex-1 order-1 lg:order-none">
        ...
        <p className="text-dark text-base font-sans font-normal leading-normal">
          ...
          team of experts is here to help you achieve that.
        </p>
        ...
        <div className="grid lg:grid-cols-2 gap-x-6 items-center">
          {WhyChooseArr.map((reason, index) => (
            ...
            >
              ...
              <div className="flex flex-col gap-2 w-full lg:h-[150px]">
